...
@@:
	...
	push esi
	push edi
	xor esi, esi                                     ; emulated beginning of the function.
...
;--------------------------------------------- creates a jump using the address of the hook proc, and the address of the hooked one.
    ...
    ;mcopy hP32Next,offset BytesToSave,9                                 ; copies some bytes to be saved : they will be overwritten by the  jump.
    add hP32Next, 5                                                     ; here P32Next is the address where we will jump inside of the hook.
    ...
    sub hP32Next, 5                                                     ; here P32Next is the address where we will jump inside of the hook.
